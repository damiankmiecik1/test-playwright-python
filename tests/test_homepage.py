...
FRONT_SECTION_LINKS = [
    ("begin_course", "https://srv88380.seohost.com.pl/2025/06/09/wpis-testowy/"),
    ("online_courses", "https://srv88380.seohost.com.pl/2025/06/09/wpis-testowy/"),
    ("experts", "https://srv88380.seohost.com.pl/2025/06/09/wpis-testowy/"),
    ("library", "https://srv88380.seohost.com.pl/2025/06/09/wpis-testowy/"),
]
...
def test_front_section_links_are_correct(home_page: HomePage, section_name: str, expected_url: str):
    """Sprawdza czy linki w sekcji frontowej są widoczne i mają poprawne atrybuty href."""
    if section_name == "begin_course":
        link_locator = home_page.get_begin_course_link()
    else:
        link_locator = home_page.get_learn_more_link(section_name)
